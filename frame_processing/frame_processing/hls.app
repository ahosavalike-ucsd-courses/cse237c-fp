<project xmlns="com.autoesl.autopilot.project" name="frame_processing" top="frame_processing" projectType="C/C++">
    ...
    <libraryPaths/>
    <Simulation argv="">
        <SimFlow name="csim" ldflags="-LC:/Users/adyan/Projects/CSE237C/game/opencv/mingw_build/install/x64/mingw/lib -llibopencv_core440 -llibopencv_imgproc440 -llibopencv_highgui440" clean="true" csimMode="0" lastCsimMode="0"/>
    </Simulation>
    <files xmlns="">
